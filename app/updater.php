<?php
// Thanks to https://anchor.host/using-github-to-self-host-updates-for-wordpress-plugins/
...
class Updater {
    ...
    public function __construct() {
        ...
        $this->version       = '1.2';
        $this->cache_key     = 'wca-bmkg_updater';
    ...
    public function request(){
        ...
        if( false === $remote || ! $this->cache_allowed ) {
            ...
            $remote = wp_remote_get( 'https://github.com/infoBMKG/wca-bmkg-plugin/blob/main/plugin-update.json', [
                    'timeout' => 10,
                    'headers' => [
